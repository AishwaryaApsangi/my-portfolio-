...
const services = [
  ...
  },
  {
    ...
    description:
      "I love spending my free time listening to indie music from artists like Beabadoobee, Steve Lacy, and The Smiths, and enjoying a good books, and exploring new cafes!",
    icon: SearchCheck,
  },
  {
  ...
  <div data-scroll data-scroll-speed=".4" className="my-64">
    ...
    <div className="mt-14 relative">
      ...
      >
        ...
        {/* Navigation Button - Only Right Side */}
        <button
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
              ...
              <a href="https://github.com/AishwaryaApsangi" target="_blank" title="Link to Github Profile" style={{ margin: '0 10px' }}>
                <img src="/assets/github.svg" alt="Github" style={{ width: '32px', height: '32px' }} />
              </a>
              {/* LinkedIn Link */}
              <a href="https://www.linkedin.com/in/aishwaryaapsangi/" target="_blank" title="Link to Linkedin Profile" style={{ margin: '0 10px' }}>
                <img src="/assets/linkedin.svg" alt="Linkedin" style={{ width: '32px', height: '32px' }} />
              </a>
            </div>
